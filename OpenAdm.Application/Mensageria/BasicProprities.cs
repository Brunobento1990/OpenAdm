...
public class BasicProprities : IBasicProperties
{
    ...
    ushort IContentHeader.ProtocolClassId => throw new NotImplementedException();

    string IContentHeader.ProtocolClassName => throw new NotImplementedException();
