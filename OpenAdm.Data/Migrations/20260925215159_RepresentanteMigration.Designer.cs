...
namespace OpenAdm.Data.Migrations
{
    ...
    [Migration("20260925215159_RepresentanteMigration")]
    partial class RepresentanteMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAdm.Domain.Entities.Estoque", b =>
                {
                    ...
                    b.HasIndex("ProdutoId", "PesoId", "TamanhoId")
                        .IsUnique();
            ...
            modelBuilder.Entity("OpenAdm.Domain.Entities.ItemPedido", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProdutoId"), new[] { "PedidoId", "PesoId", "TamanhoId", "Quantidade" });

                    b.HasIndex("TamanhoId");

                    b.HasIndex("ProdutoId", "TamanhoId", "PesoId");
            ...
            modelBuilder.Entity("OpenAdm.Domain.Entities.MovimentacaoDeProduto", b =>
                {
                    ...
                    b.HasIndex("TipoMovimentacaoDeProduto");
            ...
            modelBuilder.Entity("OpenAdm.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<bool>("VendaSomenteComEstoqueDisponivel")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("OpenAdm.Domain.Entities.Representante", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
